    ...
    <section style={bannerSectionStyle}>
      <div style={containerStyle}>
        <div style={bannerContentStyle}>
          <h5 style={{ ...progressTextStyle, marginBottom: '20px' }}>Pre-Sale Active</h5>
          ...
          <div style={featuresStyle}>
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background = 'linear-gradient(135deg, rgba(220, 38, 38, 0.3), rgba(153, 27, 27, 0.2))';
                e.currentTarget.style.borderColor = 'rgba(220, 38, 38, 0.6)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0) scale(1)';
                e.currentTarget.style.background = 'linear-gradient(135deg, rgba(220, 38, 38, 0.2), rgba(153, 27, 27, 0.1))';
                e.currentTarget.style.borderColor = 'rgba(220, 38, 38, 0.3)';
              }}
            >
              <span style={featureEmojiStyle}>🚀</span>
              <span style={featureTextStyle}>Unlimited<br/>Presale</span>
            </div>
            <div
              style={featureItemStyle}
              onMouseEnter={(e) => {
            ...
            >
              <span style={featureEmojiStyle}>⚡</span>
              <span style={featureTextStyle}>Instant<br/>Purchase</span>
            </div>
            <div
              style={featureItemStyle}
              onMouseEnter={(e) => {
            ...
            >
              <span style={featureEmojiStyle}>🔒</span>
              <span style={featureTextStyle}>Secure<br/>Contract</span>
            </div>
            <div
              style={featureItemStyle}
              onMouseEnter={(e) => {
            ...
            >
              <span style={featureEmojiStyle}>💎</span>
              <span style={featureTextStyle}>Premium<br/>Rewards</span>
            </div>
          </div>

          <h2 style={mainTitleStyle}>Unified Decentralized Platform</h2>
          ...
          <div style={progressSectionStyle}>
            <div style={progressTopTextStyle}>
              ...
              <p style={progressTextStyle}>{presaleStats.totalRaised} / {presaleStats.hardcap} ETH</p>
            </div>
            <div style={progressBarContainerStyle}>
              <div style={progressBarInnerStyle}>
                <span style={progressBarTextStyle}>{Math.round(presaleStats.progressPercentage)}%</span>
              </div>
            </div>
          </div>

          <div style={priceTextStyle}>
            <p style={priceLineStyle}>1 <span style={{ color: '#dc2626', fontWeight: 'bold' }}>SOVIETH</span> = {presaleStats.tokenPrice} ETH</p>
            <p style={priceLineStyle}>Join the Presale Now!</p>
          </div>
